...
const iconsGym = require.context("../assets/icons", false, /\.png$/);
const BodyPart = ({ item, setBodyPart, bodyPart }) => {
  ...
  try {
    iconPath = iconsGym(`./${iconName}`); // Dinamik olarak ikonları yükle
  } catch (error) {
    console.error(`Icon not found: ${iconName}`);
    iconPath = iconsGym("./lower arms.png"); // Varsayılan bir ikon göster
  }
