...
const apiKey = "YOUR_API_KEY"; // Azure'dan aldığınız API anahtarını buraya ekleyin
const endpoint = "YOUR_ENDPOINT"; // Azure'dan aldığınız endpoint URL'sini buraya ekleyin
